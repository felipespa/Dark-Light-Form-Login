...
<template>
  <div class="toggle_wrapper">
    <input :checked="isDarkMode" type="checkbox" id="dark-mode-toggle" @click="toggleThemeColor()" />
...
.toggle_wrapper {
  ...
  label:after {
    ...
    left: 5px;
    margin: auto;
    background: linear-gradient(180deg, var(--secondary), #d8860b);
    border-radius: 100%;
  ...
  input:checked + label:after {
    ...
    background: linear-gradient(180deg, var(--foreground), var(--background));
  }
